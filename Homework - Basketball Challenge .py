...
#Create new matrix
FreeThrowsAccuracy = np.matrix.round(FreeThrows / FreeThrowsAttempts,2) * 100
...
def myplot(data, playerlist = Players):
    ...
    Mrk = {"KobeBryant":"s","JoeJohnson":"o","LeBronJames":"^","CarmeloAnthony":"D","DwightHoward":"s","ChrisBosh":"o","ChrisPaul":"^","KevinDurant":"D","DerrickRose":"d","DwayneWade":"o"}
    for name in playerlist:
        plt.plot(data[Pdict[name]], c=Col[name], ls='--', marker=Mrk[name], ms='8', label=name)
...
#Visualize Free Throws Attempts per Game
